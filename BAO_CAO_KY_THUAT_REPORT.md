...
* **Team Members:**
  1. Nguyễn Thị Thương — Student ID: 23IT — Role: Fullstack Developer & Offline-First Architect — Contribution: 100%
* **🔗 Live Demo URL:** `https://vku-field-survey.pages.dev` (Triển khai trực tiếp Cloudflare Pages HTTPS)
* **💻 GitHub Repository:** `https://github.com/nguyenthithuong/vku-field-survey-pwa`
